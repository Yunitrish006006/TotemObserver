...
Map<String, dynamic> registryPage({
  ...
  'states': List.generate(
    8,
    (index) => 'minecraft:test_${offset + index}',
  ),
};
...
void main() {
  test('loads registry page zero and lazily requests missing state pages', () async {
    ...
    expect(socket.sent.length, 3, reason: 'cached ids must not request again');
